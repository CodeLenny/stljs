...
(function() {
  ...
  Stl.AsciiParser = (function(superClass) {
    extend(AsciiParser, superClass);

    function AsciiParser() {
      return AsciiParser.__super__.constructor.apply(this, arguments);
    }
    ...
    AsciiParser.prototype.parse = function(input, callback, progressCb) {
      ...
      solidModel = [];
      modelName = null;
      return this.eachLine(input, (function(_this) {
  ...
  Stl.BinaryParser = (function(superClass) {
    var VECTOR_SIZE;
      ...
      while (i < buffer.length) {
        if ((i + numBytes) <= buffer.length) {
          if (this.remainingBuf === null) {
            ...
            this.remainingBuf = null;
            results.push(this.remainingLen = 0);
          }
        } else {
          ...
          results.push(i += this.remainingLen + 1);
        }
      }
      return results;
    };
